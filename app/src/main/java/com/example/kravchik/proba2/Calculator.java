...
import com.example.kravchik.proba2.calc.AboutActivity;
import com.example.kravchik.proba2.calc.ActionType;
import com.example.kravchik.proba2.calc.CalcOperations;
import com.example.kravchik.proba2.calc.OperationType;
import com.example.kravchik.proba2.calc.Symbol;
import com.example.kravchik.proba2.calc.DivisionByZeroException;
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.submenuClassicTheme:
                    currentTheme = R.style.AppTheme2;
                    break;
